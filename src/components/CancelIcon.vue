<script setup>
const { width = 24, height = 24, size = 24 } = defineProps(['width', 'height', 'size']);
</script>

<template>
	<svg :style="{ scale: size / 24 }" :width="width" :height="height" viewBox="{{ `0 0 ${width} ${height}` }}" fill="none" xmlns="http://www.w3.org/2000/svg">
